...
def config_from_csv(scenarios_csv_path, settings_path, config_path):
...
if __name__ == '__main__':
    scenarios_csv_path = Path('inputs/exp9_tandem05_metainputs.csv')
    settings_path = Path('inputs/exp9_tandem05_settings.yaml')
    config_path = Path('inputs/config')

    config_from_csv(scenarios_csv_path, settings_path,config_path )